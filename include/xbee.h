...
#define XBEE_IOPIN_IC BIT_4


#define XbeeOpenTimer(settings, period) OpenTimer3(settings, period)
#define XbeeOpenCapture(settings) OpenCapture5(settings)
#define XbeeCaptureReady() mIC5CaptureReady()
#define XbeeReadCapture() mIC5ReadCapture()
#define XbeeCaptureClose() CloseCapture5()
